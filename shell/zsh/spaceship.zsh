# file: ~/.oh-my-zsh/custom/themes/spaceship-prompt/spaceship.zsh
# customised line is #211
#
# Spaceship ZSH
#
...
prompt_spaceship_setup() {
  ...
  PS2='$(spaceship_ps2)'
  #see: https://github.com/denysdovhan/spaceship-prompt/issues/644#issuecomment-508930173
